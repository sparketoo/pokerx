...
return [
    ...
    'servers' => [
        [
            ...
            'host' => \Hyperf\Support\env('HTTP_HOST', '127.0.0.1'),
            'port' => (int) \Hyperf\Support\env('HTTP_PORT', 18080),
    ...
    'settings' => [
        ...
        Constant::OPTION_WORKER_NUM => (int) \Hyperf\Support\env('WORKER_NUM', 2),
        Constant::OPTION_PID_FILE => dirname(__DIR__, 2).'/runtime/hyperf.pid',
