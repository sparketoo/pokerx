...
abstract class DatabaseTestCase extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        Db::statement('CREATE TEMPORARY TABLE game_players (
            ...
            ante BIGINT UNSIGNED NOT NULL,
            blind BIGINT UNSIGNED NULL,
            post_blind BIGINT UNSIGNED NOT NULL DEFAULT 0,
            straddle_blind BIGINT UNSIGNED NOT NULL DEFAULT 0,
        ...
        Db::statement("CREATE TEMPORARY TABLE game_events (
            ...
            user_id BIGINT UNSIGNED NOT NULL,
            game_id BIGINT UNSIGNED NOT NULL,
            type ENUM('START','POST_BLIND','STRADDLE_BLIND','STAGE','DEALT','ACTION','SHOW','ABORT','OVER') NOT NULL,
